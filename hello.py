...
app.config.update(dict(
    ...
    WTF_CSRF_SECRET_KEY='a csrf secretkey'
))
...
def submit():
    ...
    if form.validate_on_submit():
        ...
        f = form.file.data
        filename = form.name.data + '.csv' #secure_filename(f.filename)        
        ...
        result.to_csv(os.path.join('files', filename), index=False)
